...
/*
 * This script is originally taken and edited from Unity's 2D Game Kit asset package. 
 */
namespace MsMeta {
	public class PlayerInput : InputComponent, IDataPersister {
		...
		public InputButton Crouch = new InputButton( KeyCode.LeftShift, XboxControllerButtons.Rightstick );
		...
		protected override void GetInputs(bool fixedUpdateHappened) {
			...
			Crouch.Get( fixedUpdateHappened, inputType );
